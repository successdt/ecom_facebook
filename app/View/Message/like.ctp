...
<fb:like href="https://www.facebook.com/ecomwebpro" data-send="false" send="false" layout="box_count" width="70" show_faces="false" font="arial" fb-xfbml-state="rendered" class="fb_edge_widget_with_comment fb_iframe_widget" style="width: 50px;height: 65px; overflow: hidden;">
</fb:like>
